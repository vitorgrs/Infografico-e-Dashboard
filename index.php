        ...
        <header class="header" id="header">
            ...
            <div id="dropdown-content" class="dropdown-content">
                <ul>
                    ...
                    <li class=item id=item6><a href="#">Administrar Turma</a></li>
                </ul>
            </div>
        </header>
        ...
        <div class="container" tabindex="0" onclick="closeSidebar(), closeMenu()">
            <div class="section impar" id="part1">
                <div class="left">
                    ...
                    <a class="button-home" href="">Ver mais</a>
                </div>
                <div class="right iconsImpar">
                    <img class="icon" src="static/images/home/escola.png" alt="">
                </div>
            </div>
            <div class="section par" id="part2">
                <div class="left iconsPar">
                    <img class="icon" src="static/images/home/simboloGrafico.png" alt="">
                </div>
                <div class="right">
                    <h2>Dashboard</h2>
                    <h5>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsam, nobis saepe? A facere possimus placeat tenetur minima impedit dignissimos tempore amet, sapiente dicta voluptatum quibusdam repellendus illo accusamus nostrum aspernatur?</h5>
                    <a class="button-home" href="templates/dashboard.html">Ver mais</a>
                </div>
            </div>
